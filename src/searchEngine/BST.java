...
class BST {
    ...
    /*
     * This class sorts the links that have been sent to it into a binary search
     * tree Based on the bst generated we print out the links that have the most
     * points(most data), and the irrelevant links are stashed away. This is how the
     * search engine becomes uniquely specific in the results it displays.
     */
