...
public class SearchEngine {
	...
	public static void main(String[] args) {
        ...
        //before asking the user for his/her query we check if the data from the different sites has been loaded
	...
	private static void search(String query, UrlDetails ud) {
        /*
		*The general work of this function is to search for data and if found put it in the BST
		*When a url is ent to it, the title of the url and the user query are checked for a 
		*match. If the title itself contains/is the query it gets sent to the BST assigned with
		*the maximum points. Then the urls conatined inside that particular url are also 
		*checked for matches. If match is found the child link gets max points - 500 and is sent to the BST
		*where this data can be mapped acoording to its points and therefore releavency. After this process 
		another check is made to see for the links whose title may not have matched, 
		*if the unique words contained in those links match any of the words in
		*our query. If they do points are assigned and that url is sent to the bst too.
		*/
